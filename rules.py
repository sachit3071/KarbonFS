...
def total_revenue(data: dict, financial_index):
    ...
    """
    return data.get("financials")[financial_index].get("pnl").get("lineItems").get("net_revenue")
...
def total_borrowing(data: dict, financial_index):
    ...
    """
    long_term_borrowings = data.get("financials")[financial_index].get("bs").get("liabilities").get("long_term_borrowings")
    short_term_borrowings = data.get("financials")[financial_index].get("bs").get("liabilities").get("short_term_borrowings")
...
def iscr(data: dict, financial_index):
    ...
    """
    profit_before_interest_and_tax = data.get("financials")[financial_index].get("pnl").get("lineItems").get("profit_before_interest_and_tax")
    depreciation = data.get("financials")[financial_index].get("pnl").get("lineItems").get("depreciation")
    total_employee_benefit_expense = data.get("financials")[financial_index].get("pnl").get("lineItems").get("total_employee_benefit_expense")
    total_other_expenses = data.get("financials")[financial_index].get("pnl").get("lineItems").get("total_other_expenses")

    iscr_value = (profit_before_interest_and_tax + depreciation + 1) / (total_employee_benefit_expense + total_other_expenses + 1)
    return iscr_value
